...
* Tradu鈬o da jqGrid em Portugues por Frederico Carvalho, https://www.eyeviewdesign.pt
...
$.jgrid = {
	...
	edit : {
	    ...
	    msg: {
	        ...
	        email: "N縊 ・um endere輟 de email v疝ido",
	...
	errors : {
		errcap : "Erro",
		nourl : "N縊 especificou um url",
		norecords: "N縊 existem dados para processar",
	...
	formatter : {
		...
		date : {
			dayNames:   [
				...
				"Domingo", "Segunda-Feira", "Ter軋-Feira", "Quarta-Feira", "Quinta-Feira", "Sexta-Feira", "S畸ado"
			],
			monthNames: [
				"Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez",
				"Janeiro", "Fevereiro", "Mar輟", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"
			],
			AmPm : ["am","pm","AM","PM"],
			S: function (j) {return j < 11 || j > 13 ? ['ｺ', 'ｺ', 'ｺ', 'ｺ'][Math.min((j - 1) % 10, 3)] : 'ｺ'},
			srcformat: 'Y-m-d',
			newformat: 'd/m/Y',
			masks : {
