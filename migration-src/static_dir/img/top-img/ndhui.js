...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_strings = 
{
	...
	settings_adfilter_title : "広告フィルタ",
	settings_adfilter_desc : "不要なポップアップ広告を止めます。",
	settings_aph_title : "フィッシング対策フィルタ",
	settings_aph_desc : "フィッシングサイトだと思われるwebサイトをブロックします。",
	settings_am_title : "ウイルス対策Webフィルタ",
	settings_am_desc : "ウイルスが含まれたページをブロックします。",
	settings_ls_title : "サーチ アドバイザ",
	settings_ls_desc : "検索結果に危険なウェブサイトがある場合、警告で知らせます。",
	
	toolbar_status_ok : "このページ <br/> は安全です。",
	toolbar_status_nok : "このページは <br/> 危険です。",
	toolbar_status_err : "エラーが <br/> 発生しました。",
	toolbar_status_disabled : "このページは <br/> 検査されていません。",
	toolbar_status_untrusted : "信頼できない",
	toolbar_title : "スーパーセキュリティ ZERO",

	tool_3_tooltip : "仮想ブラウザ",
    tool_3_tooltip_xp : "お使いのOSでは対応していません",
	tool_3_tooltip_safepay : "決済ブラウザで無効にされています",
	tool_settings_text : "設定",
	tool_settings_tooltip : "設定",

	tool_dragger: "展開するにはクリックします",
    tool_dragger_hide: "クリックすると詳細を隠す",

    fraud_link: "https://www.sourcenext.info/super/"
};
...
function bd_nd_E893A5F3FE87409FB167F51A030D021C_ajax(callback)
{
	...
	this.sendRequest = function(params)
	{
		...
		this.ajax.setRequestHeader("BDNDSS_B67EA559F21B487F861FDA8A44F01C50", "10000000abb1e4d4544e0bdf544e1b2babb1e4d4f0f153b7d5edcf88d0267d2e037fb42823275144");
...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_tfHUI = new function () {
	...
	this.InSafePayBrowser = function () {
		...
		if (OS.indexOf(" スーパーセキュリティSafepay") != -1) {
			return true;
		}	
		return false;
	}
