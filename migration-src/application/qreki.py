...
Perl
    https://homepage2.nifty.com/sophia0/sub04.html
Ruby
    https://www.310f.com/exocet/hiki/?jqreki.rb
PHP
    https://www.2chan.net/script/
    https://wppluginsj.sourceforge.jp/wp-koyomi/
JAVA
    https://homepage1.nifty.com/ave/kaihatsu/qreki.htm

Migration Notes:
- unicode() → str()（Python 3 では全て str）
- xrange() → range()（Python 3 では range に統合）
- except StandardError, e: → except StandardError as e:（Python 3 構文）
"""
