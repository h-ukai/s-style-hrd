...
def load(loader_path, application_id, kind_name, email):
    ...
    command_template = "%s download_data --email=%s --config_file=%s --filename=%s --kind=%s --url=https://%s.appspot.com/remote_api"
...
def trance(): 
    ...
    dir = "C:\\Users\\casper\\PythonWorkspace\\amanedb\\src\\csvupload\\"
