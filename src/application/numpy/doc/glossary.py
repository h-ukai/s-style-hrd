...
.. glossary::
   ...
   BLAS
       `Basic Linear Algebra Subprograms <https://en.wikipedia.org/wiki/BLAS>`_
   ...
   dictionary
       ...
       `Python tutorial <https://docs.python.org/tut>`_.
   ...
   list
       ...
       tutorial <https://docs.python.org/tut>`_.  For a mapping
