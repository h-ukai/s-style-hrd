...
- URLs (http, ftp, ...) : 'https://www.scipy.org/not/real/data.txt'
...
Example::
    ...
    >>> fp = ds.open('https://www.google.com/index.html')
    >>>
...
class DataSource (object):
    ...
    Notes
    -----
    URLs require a scheme string (``https://``) to be used, without it they
    will fail::

        >>> repos = DataSource()
        >>> repos.exists('www.google.com/index.html')
        False
        >>> repos.exists('https://www.google.com/index.html')
        True
    ...
    ::
        ...
        >>> urlname = 'https://www.google.com/index.html'
        >>> gfile = ds.open('https://www.google.com/index.html')  # remote file
        >>> ds.abspath(urlname)
    ...
    def _isurl(self, path):
        ...
        # BUG : URLs require a scheme string ('https://') to be used.
...
class Repository (DataSource):
    ...
    Similarly you could use a URL for a repository::
        ...
        >>> repos = np.lib._datasource.Repository('https://www.xyz.edu/data')
